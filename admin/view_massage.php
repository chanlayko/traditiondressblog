<?php 
      ...
      if (isset($_POST['checkboxArrays'])) {
        foreach ($_POST['checkboxArrays'] as $valueId) {
          ...
          if ($result) {
            ...
            echo "<script>alert('Success ,your Item Delete.');window.location.href='view_massage.php?od_id=$order_id';</script>";
          }
        }
      }
      echo "<script>alert('Select to checkbox want to Delete for you item');window.location.href='view_massage.php?od_id=$order_id';</script>";
    }
    ...
    if (isset($_POST['success'])) {
      ...
      // $results = $sql -> execute();
        ...
        header("Location:order_information.php");
      // if($result){
      //     echo "<script>alert('Success alert preview. This alert is dismissable.');window.location.href='order_information.php';</script>";
      // }
    ...
    if (isset($_POST['draft'])) {
      ...
      // if($result AND $results){
        // echo "<script>alert('Draft alert preview. This alert is dismissable.');window.location.href='order_information.php';</script>";
      // }
    }
?>
          ...
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="m-0">Order Massage Feature</h3>
              </div>
              <br>
              <!-- <div class="card-body"> -->
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="row mb-2">
                                  <div class="col-md-6 mb-2">
                                    <label class="form-control-label">Order's First Name</label>
                                    <input type="text" class="form-control" placeholder="First Name" value="<?php echo escape($pdoResult[0]['first_name']); ?>" disabled>  
                                  </div>
                                  <div class="col-md-6">
                                    <label class="form-control-label">Order' Last Name</label>
                                    <input type="text" class="form-control" placeholder="Last Name" value="<?php echo escape($pdoResult[0]['last_name']); ?>" disabled>
                                  </div>
                                </div>
                                <div class="row mb-2">
                                  <div class="col-md-6 mb-2">
                                    <label class="form-control-label">Country</label>
                                    <input type="text" class="form-control" placeholder="Country" value="<?php echo escape($pdoResult[0]['country']); ?>" disabled>
                                  </div>
                                  <div class="col-md-6">
                                    <label class="form-control-label">Township</label>
                                    <input type="text" class="form-control" placeholder="Township" value="<?php echo escape($pdoResult[0]['towship']); ?>" disabled>
                                  </div>
                                ...
                                <div class="row mb-2">
                                  <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" class="form-control" placeholder="Company" value="<?php echo escape($pdoResult[0]['company']); ?>" disabled>
                                  </div>
                                  <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                      ...
                                      <div class="row mb-3">
                                          ...
                                          <div class="col-md-1 col-1 mb-2" >
                                            <div class="" >
                                              <input type="checkbox" class="checkbox" name="checkboxArrays[]" value="<?php echo $value['sal_post_id']; ?>">
                                            </div>
                                          </div>
                                          <?php 
                                          ...
                                          <div class="col-md-2 col-2 mb-2" style="margin-left: -10px; ">
                                            <input type="text" name="sal_qty" class="form-control" value="<?php echo $value['sal_qty']; ?>" style="text-align: center;width: 50px;" >
                                          </div>

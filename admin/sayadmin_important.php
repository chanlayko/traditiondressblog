<?php 
    ...
    if(empty($_POST['search']) && empty($_COOKIE['search'])){
      ...
      $stat = $pdo -> prepare("SELECT * FROM send_mail WHERE sayadmin='sayadmin' AND mail_star='1' ORDER BY id DESC");
      $stat -> execute();
      ...
      $stat = $pdo -> prepare("SELECT * FROM send_mail WHERE sayadmin='sayadmin' AND mail_star='1' ORDER BY id DESC LIMIT $offset,$numOfrecs");
      $stat -> execute();
      $result = $stat -> fetchAll();
      ...
      $stat = $pdo -> prepare("SELECT * FROM send_mail WHERE sayadmin='sayadmin' AND mail_star='1' AND mail LIKE '%$searchKey%' ORDER BY id DESC");
      $stat -> execute();
      $result = $stat -> fetchAll();
      ...
      $stat = $pdo -> prepare("SELECT * FROM send_mail WHERE sayadmin='sayadmin' AND mail_star='1' AND mail LIKE '%$searchKey%' ORDER BY id DESC LIMIT $offset,$numOfrecs");
      $stat -> execute();
      $result = $stat -> fetchAll();
    }

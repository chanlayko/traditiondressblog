<?php 
    ...
    if(empty($_POST['search']) && empty($_COOKIE['search'])){
      ...
      $stat = $pdo -> prepare("SELECT * FROM delete_trash WHERE author_id=$author_id AND sayadmin='admin' ORDER BY id DESC");
      $stat -> execute();
      ...
      $stat = $pdo -> prepare("SELECT * FROM delete_trash WHERE author_id=$author_id AND sayadmin='admin' ORDER BY id DESC LIMIT $offset,$numOfrecs");
      $stat -> execute();
      $result = $stat -> fetchAll();
      ...
      $stat = $pdo -> prepare("SELECT * FROM delete_trash WHERE author_id=$author_id AND sayadmin='admin' AND mail LIKE '%$searchKey%' ORDER BY id DESC");
      $stat -> execute();
      $result = $stat -> fetchAll();
      ...
      $stat = $pdo -> prepare("SELECT * FROM delete_trash WHERE author_id=$author_id AND sayadmin='admin' AND mail LIKE '%$searchKey%' ORDER BY id DESC LIMIT $offset,$numOfrecs");
      $stat -> execute();
      $result = $stat -> fetchAll();
    ...
    if (isset($_POST['delete'])) {
      ...
      if (isset($_POST['checkboxAry'])) {
        foreach ($_POST['checkboxAry'] as $checkArray) {
          ...
          if ($teResult) {
            echo "<script>alert('Sussessfully Deleted Updated');window.location.href='trash_sayadmin.php';</script>";
          }
        }
      }
    }

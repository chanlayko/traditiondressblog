<?php 
    ...
    $uspdo = $pdo -> prepare("SELECT * FROM user_order WHERE users_id=$author_id AND gift_order='' ORDER BY id DESC");
    $uspdo -> execute();
                                ...
                                ?>
                                     <tr>
                                        ...
                                        <td>
                                          ...
                                          ?>
                                            <a href='view_massage.php?od_id=<?php echo $value['id']; ?>'><button type="button" class="btn btn-block btn-outline-success" onclick="return confirm('Success ,Are you sure, you want to Checking Your Order This Items')">Success</button></a>
                                          <?php
                                            }else{
                                          ?>
                                            <a href='view_massage.php?od_id=<?php echo $value['id']; ?>'><button type="button" class="btn btn-block btn-outline-warning" onclick="return confirm('Draft ,Are you sure, you want to Checking Your Order This item')">Draft</button></a>
                                          <?php
                                            }
                                        ...
                                        <td align="center">
                                          <a href="view_massage.php?od_id=<?php echo $value['id']; ?>">
                                        ...
                                        <td>
                                          <a href="send_massage.php?id=<?php echo $value['id']; ?>">

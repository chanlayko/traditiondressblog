<?php 
    ...
    if(empty($_POST['search']) && empty($_COOKIE['search'])){
      ...
      $stat = $pdo -> prepare("SELECT * FROM send_mail WHERE sayadmin='sayadmin' ORDER BY id DESC");
      $stat -> execute();
      ...
      $stat = $pdo -> prepare("SELECT * FROM send_mail WHERE sayadmin='sayadmin' ORDER BY id DESC LIMIT $offset,$numOfrecs");
      $stat -> execute();
      $result = $stat -> fetchAll();
      ...
      $stat = $pdo -> prepare("SELECT * FROM send_mail WHERE sayadmin='sayadmin' AND mail LIKE '%$searchKey%' ORDER BY id DESC");
      $stat -> execute();
      $result = $stat -> fetchAll();
      ...
      $stat = $pdo -> prepare("SELECT * FROM send_mail WHERE sayadmin='sayadmin' AND mail LIKE '%$searchKey%' ORDER BY id DESC LIMIT $offset,$numOfrecs");
      $stat -> execute();
      $result = $stat -> fetchAll();
    }
                  ...
                  <table class="table table-hover table-striped">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="mailbox-name"><a href="sayadmin_read_massage.php?massage_id=<?php echo $value['id']; ?>"><?php echo $value['order_method'] == 'income'? '<i class="fas fa-reply" style="color:red;"></i> Incoming' : '<i class="fas fa-share" style="color:green;"></i> Sending' ?></a></td>
